...
public class BeamDestinationFacade extends AbstractFacade<BeamDestination> {
    ...
    public List<BeamDestination> findAllForBeamAuth() {
        Query q = em.createNativeQuery("select * from beam_destination where beam_destination_id in (select beam_destination_id from beam_destination where ACTIVE_YN = 'Y') order by weight", BeamDestination.class);
    ...
    public List<BeamDestination> findCebafDestinations() {
        Query q = em.createNativeQuery("select * from beam_destination where beam_destination_id in (select beam_destination_id from beam_destination where machine = 'CEBAF' and ACTIVE_YN = 'Y') order by weight", BeamDestination.class);
    ...
    public List<BeamDestination> findLerfDestinations() {
        Query q = em.createNativeQuery("select * from beam_destination where beam_destination_id in (select beam_destination_id from beam_destination where machine = 'LERF'  and ACTIVE_YN = 'Y') order by weight", BeamDestination.class);
    ...
    public List<BeamDestination> findUitfDestinations() {
        Query q = em.createNativeQuery("select * from beam_destination where beam_destination_id in (select beam_destination_id from beam_destination where machine = 'UITF'  and ACTIVE_YN = 'Y') order by weight", BeamDestination.class);
